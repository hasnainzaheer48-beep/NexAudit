...
export default function Clients() {
    ...
    return (
        <div>
            <button className="border" onClick={handleCreateClient}>Create Audit Template</button>
                        ...
                        auditTemplates.map((auditTemplate) => {
                            return (
                                <tr key={client.id}>
                                    ...
                                    <td className="border px-4 py-3">{auditTemplate.is_active}</td>
                                    ...
                                    <td className="border px-4 py-3"><button onClick={() => {
                                        setSelectedAuditTemplate(client);
                                        setShowModal(true);
                                    }}>Edit</button></td>
                                </tr>
                            );
